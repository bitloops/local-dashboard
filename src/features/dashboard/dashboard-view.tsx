...
export function DashboardView({
  ...
  const onCheckpointSheetOpenChange = (open: boolean) => {
    if (!open) {
    ...
    <>
      ...
      <Main>
        ...
        <div className='mt-6'>
          ...
          <CommitTable data={rows} onCheckpointClick={setSelectedCheckpoint} />
        </div>
      </Main>

      <Sheet
        open={Boolean(selectedCheckpoint)}
        onOpenChange={onCheckpointSheetOpenChange}
      >
                ...
                <>
                  <div className='space-y-3'>
                    <div className='flex items-center gap-2'>
                      ...
                      {selectedCheckpoint.branch && (
                        <Badge variant='secondary'>
                          branch:{selectedCheckpoint.branch}
                        </Badge>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    <DetailRow
                      label='Strategy'
                      value={selectedCheckpoint.strategy ?? '-'}
                    />
                    <DetailRow
                      label='Tool Use ID'
                    ...
                    <DetailRow
                      label='Commit'
                      value={selectedCheckpoint.commit ?? '-'}
                    />
                    <DetailRow
                      label='Sessions'
                      value={String(selectedCheckpoint.sessionCount ?? 0)}
                    />
                    <DetailRow
                      label='Checkpoints'
                      value={String(selectedCheckpoint.checkpointsCount ?? 0)}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    {selectedCheckpoint.filesTouched &&
                    selectedCheckpoint.filesTouched.length > 0 ? (
                      <div className='flex flex-wrap gap-2'>
                        {selectedCheckpoint.filesTouched.map((filePath) => (
